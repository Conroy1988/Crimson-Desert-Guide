...
const tools = [
  ...
  ['tool-boss-intelligence', 'Boss Intelligence Centre', 'Official rematches, encounter mechanics, patch history and explicit boss evidence gaps.', '/database/bosses/', 'tool', 'full', 'official-boss-forest-colossus'],
