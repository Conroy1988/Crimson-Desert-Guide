...
### **THE EVIDENCE-LED FIELD GUIDE TO PYWEL**
...
<td width="25%" align="center"><a href="https://crimson-desert-guide.dannyconroy.workers.dev/command-centre/"><strong>⌘ COMMAND CENTRE</strong><br><sub>Plan and continue</sub></a></td>
...
## A living companion to Pywel

Crimson Desert is too large, interconnected and changeable for a loose pile of articles. This project treats the game as a living world that must be **mapped, verified, cross-referenced and maintained**.
...
<table>
<tr>
<td width="25%" valign="top"><strong>📜 Patch-aware</strong><br><sub>Every page declares its patch status, verification date and evidence grade.</sub></td>
<td width="25%" valign="top"><strong>🗺 World-connected</strong><br><sub>Regions, routes, services, missions, characters and collectibles link into one knowledge graph.</sub></td>
<td width="25%" valign="top"><strong>✓ Completion-ready</strong><br><sub>Local-first progress tracking, filters, spoiler controls and portable JSON backups.</sub></td>
<td width="25%" valign="top"><strong>🔎 Evidence-led</strong><br><sub>Official facts, reproduced findings and unresolved leads remain visibly distinct.</sub></td>
</tr>
</table>
...
<table>
<tr>
<td width="33%" valign="top"><strong>🧭 Pywel Atlas</strong><br><sub>A route-intelligence centre for regions, landmarks, services and discoveries.</sub></td>
<td width="33%" valign="top"><strong>⚒ Build Laboratory</strong><br><sub>Structured character, equipment and progression planning instead of isolated build lists.</sub></td>
<td width="33%" valign="top"><strong>📚 Content Database</strong><br><sub>Searchable sourced records spanning quests, encounters, collectibles and world knowledge.</sub></td>
</tr>
<tr>
<td width="33%" valign="top"><strong>⌘ Expedition Command Centre</strong><br><sub>Unified search, session planning, spoiler preferences, recent-guide continuation and complete local backups.</sub></td>
...
<img src="https://s1.pearlcdn.com/cd/brand/media_GLOBAL/2026/04/02/88160ecb27920260402105234327.png" alt="Kliff facing an immense living tree creature in Pywel" width="100%">

---

## Evidence before folklore

Every guide page can be audited back to its source and the game state in which it was verified.
...
| **`provisional`** | A useful lead that still requires confirmation |
...
The patch monitor checks official announcements automatically and opens review work when the live game moves beyond the documented baseline.
...
```text
OFFICIAL SOURCES + CONTROLLED TESTING + CORROBORATED REPORTS
                            ↓
          PATCH METADATA + EVIDENCE GRADES + SPOILER LEVELS
                            ↓
...
```text
src/content/docs/       Guide pages and standards
src/components/         Interactive guide experiences
src/styles/             Cinematic site presentation
public/media/            Soundtrack and public media

data/                   Patch, world, completion and export records
scripts/                Generation, audit, testing and publishing tools
.github/                CI, security, issue forms and patch monitoring
docs/                   Operator and deployment instructions
```

---

## Official imagery and fan-content notice

The promotional imagery shown in this README comes from official Crimson Desert media and store assets. Crimson Desert names, trademarks, screenshots, music and other game materials remain the property of **Pearl Abyss** and are excluded from this repository's software and written-content licences.

- [Official Crimson Desert media gallery](https://crimsondesert.pearlabyss.com/en-US/Media)
- [Official Crimson Desert Fan Kit](https://static.pearlcdn.com/asset/brand/cd/contents_cd/files/fankit_241206.zip)
- [Pearl Abyss Fan Content Guidelines](https://crimsondesert.pearlabyss.com/Policy/policy/index/?policyNo=2)
...
- Crimson Desert and third-party game assets: excluded from those licences
